...
async function executeSearch(query) {
	...
	// This is where we send the search query to the 'https://firewall.flamepass.com/@/index.html?uul=...' format
	window.location.href = `https://firewall.flamepass.com/@/index.html?uul=${encodeURIComponent(encodedUrl)}`;
}
