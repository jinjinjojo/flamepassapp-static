    ...
    proxyGameBtn.addEventListener('click', (e) => {
      ...
      if (game.category === 'emulator' && gameUrl && gameUrl.includes('nettleweb.com')) {
        ...
        if (isLoggedIn) {
          ...
          const proxyUrl = `https://app.flamepass.comhttps://flamepass-proxy.vercel.app/@/index.html?uul=${encodeURIComponent(gameUrl)}`;
        ...
        if (isLoggedIn) {
          ...
          window.open(`https://flamepass-proxy.vercel.app/@/index.html?uul=${encodeURIComponent(gameUrl)}`, '_blank');
...
function setupCloudProviders(game) {
  ...
  proxyButtons.forEach(button => {
    button.addEventListener('click', (e) => {
      ...
      if (isLoggedIn) {
        // User is logged in, redirect to proxy
        window.open(`https://flamepass-proxy.vercel.app/@/index.html?uul=${providerUrl}`, '_blank');
      } else {
        // User is not logged in, show auth modal from auth-controller.js
        if (window.showAuthModal) {
          window.showAuthModal();
  ...
  const tips = [
    {
      ...
      description: 'We have a built in website proxy inside Flamepass that you can access when you log into your Flamepass account. Our secure proxy can bypass most school filters and keeps your gaming activity hidden from monitoring systems.'
    },
    {
      icon: 'fa-clock',
      title: 'Find New Links',
      description: 'Find new unblocker links, by going to our <a href="/ultimate-links.html">Ultimate Links</a> page where we have over 500 updated proxy links. Also join our free Discord server for annoucements and updates.'
    },
    {
      icon: 'fa-bolt',
      title: 'Use About:Blank Cloaking',
      description: 'Launch games through an about:blank page to hide the actual URL from basic monitoring systems. This method helps prevent detection by school web filters. Access this feature in <a href="/~.html">Settings</a>.'
    }
  ];
    ...
    <div class="advanced-tips-grid">
      <div class="advanced-tip">
        ...
        <div class="advanced-tip-content">
          ...
          <p>Focus on WebGL-based games like Krunker.io and Shell Shockers that often work even on restricted networks. Check our <a href="/g.html?category=browser">Browser Games</a> section for a full list of these games.</p>
        </div>
      </div>
      ...
      <div class="advanced-tip">
        ...
        <div class="advanced-tip-content">
          ...
          <p>Join proxy Discord servers like Interstellar or Mercury Workshop to get fresh links that bypass filters. Check our <a href="/guides.html">Guides</a> page for 10+ top proxy Discord Server links.</p>
        </div>
      </div>
    </div>
  `;
