...
function showLoginModal() {
  ...
  if (authModal) {
    ...
    // Use auth controller if available
    if (typeof window.showLoginPopup === 'function') {
      window.showLoginPopup();
    } else {
 ...
 * Incorporates improved UI with parallax background effects
 * Consolidates descriptions and adds better category-based related games
 */
  ...
  if (game.category === 'cloud') {
    ...
    gameInfoHTML += `
      <div class="service-providers-section">
        <h3 class="providers-title"><i class="fa-solid fa-cloud"></i> Cloud Gaming Providers</h3>
