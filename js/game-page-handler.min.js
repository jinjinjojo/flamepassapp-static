    ...
    proxyGameBtn.addEventListener('click', (e) => {
      ...
      if (game.category === 'emulator' && gameUrl && gameUrl.includes('nettleweb.com')) {
        ...
        if (isLoggedIn) {
          ...
          const proxyUrl = `https://firewall.flamepass.com/@/index.html?uul=${encodeURIComponent(gameUrl)}`;
        ...
        if (isLoggedIn) {
          ...
          window.open(`https://firewall.flamepass.com/@/index.html?uul=${encodeURIComponent(gameUrl)}`, '_blank');
...
function setupCloudProviders(game) {
  ...
  proxyButtons.forEach(button => {
    button.addEventListener('click', (e) => {
      ...
      if (isLoggedIn) {
        // User is logged in, redirect to proxy
        window.open(`https://firewall.flamepass.com/@/index.html?uul=${providerUrl}`, '_blank');
      } else {
        // User is not logged in, show auth modal from auth-controller.js
        if (window.showAuthModal) {
          window.showAuthModal();
