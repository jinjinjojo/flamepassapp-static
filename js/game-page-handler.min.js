...
function initUnblockTipsSection() {
  ...
  // Define tips (reduced to 3 with more useful information)
  const tips = [
    {
      icon: 'fa-shield',
    ...
    {
      icon: 'fa-clock',
      title: 'Try Cloud Gaming',
      description: 'Use cloud gaming services like GeForce NOW through our proxy to play AAA games. Access through play.geforcenow.com and connect your Steam or Epic Games accounts.'
    },
    {
      icon: 'fa-bolt',
    ...
    <div class="advanced-tips-grid">
      <div class="advanced-tip">
        ...
        <div class="advanced-tip-content">
          ...
          <p>Some school filters rely on browser identification. Try changing your user agent to appear as a different device to bypass detection.</p>
        </div>
      </div>
